...
import { 
 Home, Search, Network, Activity, Settings
} from "lucide-react";
...
const navItems = [
  ...
  { name: "Connections", href: "/connections", icon: Network }, // NOWE
  { name: "Streams", href: "/streams", icon: Activity },       // NOWE
  ...
  return (
    <div className="w-64 border-r border-border bg-background-card flex flex-col h-screen p-4">
      ...
      <div className="mb-8 px-2 flex items-center gap-2">
         <div className="w-8 h-8 bg-primary rounded-lg flex items-center justify-center font-bold text-white">CS</div>
