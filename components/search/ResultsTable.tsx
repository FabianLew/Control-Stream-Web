          ...
          {messages.map((msg, index) => {
            ...
            return (
              ...
              >
                ...
                <TableCell
                  className="font-mono text-xs text-foreground/80 truncate max-w-[150px]"
                  title={msg.correlationId || undefined}
                >
                  {msg.correlationId || "-"}
                </TableCell>
                ...
                <TableCell className="text-muted-foreground text-sm">
                  <div className="flex items-center gap-2">
                    <FileJson
                      size={14}
                      className="text-primary opacity-50 group-hover:opacity-100 transition-opacity shrink-0"
                    />
